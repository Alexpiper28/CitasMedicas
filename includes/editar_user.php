                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="contrasena" id="contrasena" class="form-control" value="<?php echo $usuario ['contrasena']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                  ...
                                  <option <?php echo $usuario ['rol']==='2' ? "selected='selected' ": "" ?> value="2">Secretario(a)</option>
                                  <option <?php echo $usuario ['rol']==='3' ? "selected='selected' ": "" ?> value="3">Paciente</option>
                                  <option <?php echo $usuario ['rol']==='4' ? "selected='selected' ": "" ?> value="4">Médico</option>
