...
$sql = "SELECT  user.id, user.nombre, user.correo, user.contrasena, user.fecha,
roles.rol FROM user 
    ...
    <div class="contenedor-perfil">
        <div class="portada-perfil" style="background-image: url('../img/portada.jpg');">
            ...
            <div class="datos-perfil">
                ...
                <p class="bio-usuario">SanaCitas - Sistema de gestión de citas médicas para clínicas de atención primaria</p>
