    ...
    <div class="container-fluid">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <h1>
                    Sistema de gestión de citas médicas para clínicas de atención primaria "SanaCitas"
                </h1>
                <br>

                <p> SanaCitas es un sistema de información de citas medicas web <b>basico</b> su funcion principal
